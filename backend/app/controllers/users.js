...
exports.loginuser = (req, res) => {
    ...
    const {user_name, password, device_type, device_token} = req.body;
    let errors = '';
    ...
    Users.loginuser(user_name, password, (err, logindata) => {
